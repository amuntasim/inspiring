...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#contactform').submit(function () {
            ...
            $('#contact #submit').after('<img src="loader.gif" class="loader" />');
...
$(function () {
    ...
    $(".timeago").timeago();
    $('.forget-password-tab').click(function () {
        $('a.forget-password-tab-link').trigger('click');
    })
...
$(document).on('click', '.open-login-dialog', function (e) {
    e.preventDefault();
    openLoginPopup();
})
